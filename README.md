...
[![Latest Release](https://img.shields.io/github/v/release/innovatekswd/mini-cluster?label=v1.8.1)](https://github.com/innovatekswd/mini-cluster/releases/latest)
...
### Quick Download — v1.8.1

| Platform | Download |
|----------|----------|
| 🐧 Linux (.deb) | [minicluster_1.8.1_amd64.deb](https://github.com/innovatekswd/mini-cluster/releases/download/v1.8.1/minicluster_1.8.1_amd64.deb) |
| 🐧 Linux (.tar.gz amd64) | [minicluster-api-1.8.1-linux-amd64.tar.gz](https://github.com/innovatekswd/mini-cluster/releases/download/v1.8.1/minicluster-api-1.8.1-linux-amd64.tar.gz) |
| 🐧 CLI (standalone) | [mc-linux-amd64](https://github.com/innovatekswd/mini-cluster/releases/download/v1.8.1/mc-linux-amd64) |
| 🪟 Windows (.zip) | [minicluster-1.8.1-windows-amd64.zip](https://github.com/innovatekswd/mini-cluster/releases/download/v1.8.1/minicluster-1.8.1-windows-amd64.zip) |
...
mc login --server http://1.8.168.1.100:2016
...
mc registry show my-package@1.8.1
...
mc inspect my-package@1.8.1          # inspect from registry
```
