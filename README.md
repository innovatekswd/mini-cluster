...
[![Latest Release](https://img.shields.io/github/v/release/innovatekswd/mini-cluster?label=v1.12.4)](https://github.com/innovatekswd/mini-cluster/releases/latest)
...
### Quick Download — v1.12.4

| Platform | Download |
|----------|----------|
| 🐧 Linux (.deb) | [minicluster_1.12.4_amd64.deb](https://github.com/innovatekswd/mini-cluster/releases/download/v1.12.4/minicluster_1.12.4_amd64.deb) |
| 🐧 Linux (.tar.gz amd64) | [minicluster-api-1.12.4-linux-amd64.tar.gz](https://github.com/innovatekswd/mini-cluster/releases/download/v1.12.4/minicluster-api-1.12.4-linux-amd64.tar.gz) |
| 🐧 CLI (standalone) | [mc-linux-amd64](https://github.com/innovatekswd/mini-cluster/releases/download/v1.12.4/mc-linux-amd64) |
| 🪟 Windows (.zip) | [minicluster-1.12.4-windows-amd64.zip](https://github.com/innovatekswd/mini-cluster/releases/download/v1.12.4/minicluster-1.12.4-windows-amd64.zip) |
...
mc login --server http://1.12.468.1.100:2016
...
mc registry show my-package@1.12.4
...
mc inspect my-package@1.12.4          # inspect from registry
```
