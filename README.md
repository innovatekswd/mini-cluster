...
[![Latest Release](https://img.shields.io/github/v/release/innovatekswd/mini-cluster?label=v1.1.1)](https://github.com/innovatekswd/mini-cluster/releases/latest)
...
| Platform | Download |
|----------|----------|
| 🐧 Linux (.deb) | [minicluster_1.1.1_amd64.deb](https://github.com/innovatekswd/mini-cluster/releases/download/v1.1.1/minicluster_1.1.1_amd64.deb) |
| 🐧 Linux (.tar.gz amd64) | [minicluster-api-1.1.1-linux-amd64.tar.gz](https://github.com/innovatekswd/mini-cluster/releases/download/v1.1.1/minicluster-api-1.1.1-linux-amd64.tar.gz) |
| 🐧 CLI (standalone) | [mc-linux-amd64](https://github.com/innovatekswd/mini-cluster/releases/download/v1.1.1/mc-linux-amd64) |
| 🪟 Windows (.zip) | [minicluster-1.1.1-windows-amd64.zip](https://github.com/innovatekswd/mini-cluster/releases/download/v1.1.1/minicluster-1.1.1-windows-amd64.zip) |
