...
[![Latest Release](https://img.shields.io/github/v/release/innovatekswd/mini-cluster?label=v1.10.0)](https://github.com/innovatekswd/mini-cluster/releases/latest)
...
### Quick Download — v1.10.0

| Platform | Download |
|----------|----------|
| 🐧 Linux (.deb) | [minicluster_1.10.0_amd64.deb](https://github.com/innovatekswd/mini-cluster/releases/download/v1.10.0/minicluster_1.10.0_amd64.deb) |
| 🐧 Linux (.tar.gz amd64) | [minicluster-api-1.10.0-linux-amd64.tar.gz](https://github.com/innovatekswd/mini-cluster/releases/download/v1.10.0/minicluster-api-1.10.0-linux-amd64.tar.gz) |
| 🐧 CLI (standalone) | [mc-linux-amd64](https://github.com/innovatekswd/mini-cluster/releases/download/v1.10.0/mc-linux-amd64) |
| 🪟 Windows (.zip) | [minicluster-1.10.0-windows-amd64.zip](https://github.com/innovatekswd/mini-cluster/releases/download/v1.10.0/minicluster-1.10.0-windows-amd64.zip) |
...
mc login --server http://1.10.068.1.100:2016
...
mc registry show my-package@1.10.0
...
mc inspect my-package@1.10.0          # inspect from registry
```
