...
| 4 | Authentication | [003](../spec/003-authentication/spec.md) | 🔶 Partial | 2 weeks |
| 5 | Reliability & Orchestration | [005](../spec/005-reliability-orchestration/spec.md) | 📋 Spec | 12-16 weeks |
...
**What it replaces:** PM2, Supervisor, systemd units, manual nginx config, deploy scripts.

**Milestone:** First app running in <10 minutes. No external dependencies.
