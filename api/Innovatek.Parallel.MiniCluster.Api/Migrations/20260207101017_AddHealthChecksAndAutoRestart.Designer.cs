...
namespace Innovatek.Parallel.MiniCluster.Api.Migrations.AppDb
{
    ...
    [Migration("20260207101017_AddHealthChecksAndAutoRestart")]
    partial class AddHealthChecksAndAutoRestart
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Innovatek.Parallel.MiniCluster.Core.Entities.AppSettings", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ModifiedAt = new DateTime(2026, 2, 7, 10, 10, 14, 253, DateTimeKind.Utc).AddTicks(1022)
                        });
                });
            ...
            modelBuilder.Entity("Innovatek.Parallel.MiniCluster.Core.Entities.ProxySettings", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PortRangeEnd = 5099,
                            PortRangeStart = 5001,
                            UpdatedAt = new DateTime(2026, 2, 7, 10, 10, 14, 260, DateTimeKind.Utc).AddTicks(7785)
                        });
                });
