...
namespace Innovatek.Parallel.MiniCluster.Api.Migrations
{
    ...
    [Migration("20260131123621_AddAppsTable")]
            ...
            modelBuilder.Entity("Innovatek.ControlCenter.Core.Entities.AppSettings", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ModifiedAt = new DateTime(2026, 1, 31, 12, 36, 18, 848, DateTimeKind.Utc).AddTicks(5079)
                        });
                });
            ...
            modelBuilder.Entity("Innovatek.ControlCenter.Core.Entities.ProxySettings", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PortRangeEnd = 5099,
                            PortRangeStart = 5001,
                            UpdatedAt = new DateTime(2026, 1, 31, 12, 36, 18, 856, DateTimeKind.Utc).AddTicks(6577)
                        });
                });
