...
namespace Innovatek.Parallel.MiniCluster.Api.Migrations.AppDb
{
    ...
    [Migration("20260206202425_AddMachineClusterFields")]
    partial class AddMachineClusterFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Innovatek.Parallel.MiniCluster.Core.Entities.AppSettings", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ModifiedAt = new DateTime(2026, 2, 6, 20, 24, 21, 553, DateTimeKind.Utc).AddTicks(1814)
                        });
                });
            ...
            modelBuilder.Entity("Innovatek.Parallel.MiniCluster.Core.Entities.ProxySettings", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PortRangeEnd = 5099,
                            PortRangeStart = 5001,
                            UpdatedAt = new DateTime(2026, 2, 6, 20, 24, 21, 562, DateTimeKind.Utc).AddTicks(1253)
                        });
                });
